...
public class Testldap {
	...
	public static void main(String[] args) {
	    ...
	    Map resultMap = parseResult((String)result);
	    String ldapResponse = resultMap != null ? (String)resultMap.get("status") : "false";

	    System.out.println("Status : "+ldapResponse);
	...
	public static String generateReqData(String username, String password)
	{
	return "<userdetail><username>" + username + "</username><password>" + password
	        + "</password></userdetail>";
	}
